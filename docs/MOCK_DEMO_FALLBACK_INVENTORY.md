...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **MOCK-01** | `frontend/components/workspace/TerminalPanel.tsx` | **UI Simulation / Mock Shell** | Simulated terminal execution by appending `Exit code: 0` to React state. | **NO** (RESOLVED in Phase 2) | **YES** (`tests/test_phase2_sandbox_terminal.py`) | **RESOLVED (Phase 2)**: Replaced with real subprocess execution via `POST /api/v1/sandbox/{run_id}/exec`. |
