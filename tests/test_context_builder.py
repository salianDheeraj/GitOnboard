...
import backend.routers.repo.intelligence as intelligence_module
...
def test_context_builder_endpoint_returns_feature_and_graph_context(monkeypatch):
    ...
    # _get_latest_analysis is not called by the intelligence router directly, so we don't need to mock it.
